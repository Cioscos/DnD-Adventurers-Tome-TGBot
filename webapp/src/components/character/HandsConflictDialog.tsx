    ...
    <Sheet open onClose={onCancel} centered title={t('character.equipment.hands_conflict.title')}>
      <div className="p-5 space-y-4">
        <div className="flex justify-center">
          <span className="w-12 h-12 rounded-full flex items-center justify-center border text-dnd-amber border-dnd-amber/50 bg-dnd-amber/15">
        ...
        <div className="flex gap-2">
          ...
          <Button
            ...
            loading={pending}
            haptic="warning"
            className="!text-dnd-amber !border-dnd-amber/55"
          >
