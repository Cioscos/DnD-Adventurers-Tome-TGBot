...
export default function CharacterSwiper({ hero, equipment, menu }: Props) {
  ...
  return (
    <div ref={containerRef} className="relative flex-1 min-h-0 overflow-hidden">
      ...
      >
        <div style={{ width, touchAction: 'pan-y' }} className="h-full overflow-y-auto overscroll-contain shrink-0 pb-24">{hero}</div>
        <div style={{ width, touchAction: 'pan-y' }} className="h-full overflow-y-auto overscroll-contain shrink-0 pb-24">{equipment}</div>
        <div style={{ width, touchAction: 'pan-y' }} className="h-full overflow-y-auto overscroll-contain shrink-0 pb-24">{menu}</div>
      </m.div>
